...
public class MainClass {
  public static void main(String[] args) {
     ...
     *    1) 기본 자료형(타입)
     *      (1) 값 자체를 저장하려는 ROW DATA 타입이다.
     *      (2) 8가지 타입이 제공된다.
     *        byte, short, int, long, float, double, char, boolean
     *    2) 참조 자료형(타입)
     *      (1) 값이 저장된 참조값을 저장하는 REFERENCE DATA 타입이다. 값 자체가 저장된게 아니라 주소가 저장 되다.
    ...
    boolean isAilve = false;
    System.out.println(isAilve);
