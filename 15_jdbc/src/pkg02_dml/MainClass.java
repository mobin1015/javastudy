...
public class MainClass {
   ...
   *    PreparedStatement ps = con.prepareStatment(쿼리문);
   */
  ...
  public static void method1() {
    ...
    try {
      ...
      // 쿼리문 
      String sql = "INSERT INTO SAMPLE_T(SAMPLE_NO, SAMPLE_CONTENT, SAPMLE_EDITOR, SAMPLE_DT) VALUES(SAMPLE_SEQ.NEXTVAL, '콘텐츠', '에디터', CURRENT_DATE)";
  ...
  public static void method2() {
    ...
    try {
      ...
      String sql = "INSERT INTO SAMPLE_T(SAMPLE_NO, SAMPLE_CONTENT, SAPMLE_EDITOR, SAMPLE_DT) VALUES(SAMPLE_SEQ.NEXTVAL, ?, ?, CURRENT_DATE)";
  ...
  public static void method3() {
    ...
    try {
      ...
      String sql = "UPDATE SAMPLE_T SET SAPMLE_EDITOR = SAMPLE_CONTENT || 2 , SAMPLE_DT = CURRENT_DATE WHERE SAMPLE_NO = ?  ";
