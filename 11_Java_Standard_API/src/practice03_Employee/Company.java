...
public class Company {
  ...
  public void hire(Employee employee) throws RuntimeException {
    ...
    if(employees.contains(employee)) {
      throw new RuntimeException("이미 등록된 사원 번호 입니다.");
    }
   ...
   * if(employees.get(i).getEmpNo() == empNo) { employees.remove(i); break; } }
  */
    
  }
  
  // 조회
  public void search(int empNo) throws RuntimeException {
    ...
    // 내 방법
    /*
     * for(Employee employee :employees) { if(employee.getEmpNo() == empNo) {
     * employee.info(); } }
     */
    ...
    // 강사님 방법
      ...
      Employee searchEmployee = new Employee(empNo, null); for(Employee employee
      :employees) { if(employee.equals(searchEmployee)) { employee.info(); } }
