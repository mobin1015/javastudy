...
public class MainClass {
  ...
  public static void method2() {
    ...
    if(file.exists()) {  // 파일이 있으면
      ...
      try {
        file.createNewFile(); // IOException 처리가 반드시 필요하다(체크드 입셉션)
      } catch (Exception e) {
        e.printStackTrace();
      }
    }
  ...
  public static void method3() {
    ...
    for(File file : files) {
      ...
      // 이름 
      builder.append(String.format("%-20s", file.getName().substring(Math.min(file.getName().length(), 20))));
...
//    practice1();
  ...
  public static void practice1() {
    ...
    /*
     * Date date = new Date(); SimpleDateFormat sdf = new SimpleDateFormat("yy");
     * SimpleDateFormat sdf2 = new SimpleDateFormat("mm"); SimpleDateFormat sdf3 =
     * new SimpleDateFormat("dd"); String result = sdf.format(date); String result2
     * = sdf2.format(date); String result3 = sdf3.format(date);
     * 
     * File dir = new File("\\"+result + "\\" + result2 + "\\" + result3);
     */
...
//    
//    
//    File dir = new File("\\"+result.substring(0,4)+"\\"+result.substring(5,7)+"\\"+result.substring(8,10));
//    File dir2 = new File("\\"+result.substring(0,4)+"\\"+result.substring(5,7));
//    File dir3 = new File("\\"+result.substring(0,4));
//    dir.delete();         
//    dir2.delete();         
//    dir3.delete();         
