...
public class MainClass {
  ...
  /*
   * java.io.FileReader 1. 문자 기반의 파일 입력 스트림이다. 2. 입력 단위 1) int 2) char[] 3) String
   */

  /*
   * java.io.BufferedReader 
   * 1. 버퍼링을 지원하는 문자 입력 스트림이다. 
   * 2. 보조 스트림으로 메인 스트림과 함께 사용해야
   * 한다. 
   * 3. 버퍼링을 지원하므로 입력 속도가 향상된다. 4. 한 줄씩 읽는 readLine() 메소드가 있다.
   */
  ...
  public static void method1() {
    ...
    try {
      ...
      while (true) {
        ...
        builder.append(cbuf, 0, readChar); // cbuf[0]부터 readChar만큼 builder
